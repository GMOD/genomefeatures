...
const vcfTabixUrl =
  `${baseUrl}/s3.amazonaws.com/agrjbrowse/VCF/7.0.0/worm-latest.vcf.gz`
const ncListUrlTemplate =
  `${baseUrl}/s3.amazonaws.com/agrjbrowse/docker/7.0.0/WormBase/c_elegans_PRJNA13758/tracks/All_Genes/{refseq}/trackData.jsonz`
